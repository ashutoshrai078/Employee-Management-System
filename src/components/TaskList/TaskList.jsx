  ...
  return (
    <div id='tasklist' className='h-[55%] flex overflow-x-auto items-center justify-start flex-nowrap gap-4 w-full py-5 mt-7'>
      <div className='h-full shrink-0 w-[300px] p-5 bg-yellow-400 rounded-xl'>
        ...
        <p className='text-sm mt-2'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aut sit eius recusandae qui, sequi soluta?</p>
      </div>
      <div className='h-full shrink-0 w-[300px] p-5 bg-emerald-400 rounded-xl'>
        <div className='flex justify-between items-center'>
          <h3 className='bg-red-600 text-sm px-3 py-1 rounded'>High</h3>
          <h4 className='text-sm'>20 feb 2024</h4>
        </div>
